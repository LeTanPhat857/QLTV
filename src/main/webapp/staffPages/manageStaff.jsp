...
<body>
	<div class="container-xxl"
		...
		<div class="content d-flex justify-content-between"
			...
			<a type="button" href="addStaff.jsp"
				class="btn btn-primary p-2 bd-highlight rounded-pill"
				data-toggle="button" aria-pressed="false">Thêm nhân viên</a>
		</div>
		<div class="content ">
			<nav class="navbar navbar-expand-lg navbar-light bg-light border border-dark rounded ">
				<div class="nav-item dropdown border border-dark rounded" style= "margin-right: 10px"><a
					class="nav-link dropdown-toggle text-dark" data-toggle="dropdown" href="#"
					role="button" aria-haspopup="true" aria-expanded="false">Nhập từ khóa bất kỳ</a>
				...
				<form class="form-inline my-2 my-lg-0">
					...
					<button class="btn btn-primary border border-primary rounded-0" type="submit">tìm</button>
				</form>
