...
<div class="container-xxl"
    ...
    <div class="content d-flex justify-content-between"
         style="height: auto;">
        <div class="title  p-2 bd-highlight">Thêm nhân viên</div>

    </div>
    <div class="content text-center border border-dark rounded p-2 mr-5 mt-3	" style="width:80%;height:auto ">
        <form  action="registerLibraryCard" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-6">
                    <img alt="" class="img-thumbnail rounded mx-auto d-block" style="max-width: 80%"
                         src="images/user/0.jpeg">
                    <input type="file" name="fileImg" placeholder="avatar" multiple><br><br>
                </div>
                <div class=" col-6 row">
                    <div class="form-group row col-12">
                        ...
                        <select class="custom-select col-8"
                            ...
                            <option value="1" name="object">sinh viên</option>
                    ...
                    <div class="form-group row col-12">
                        <%--@declare id="student_code"--%><label for="student_code" class="col-4 col-form-label">Mã số sinh viên
                        </label>
                        <div class="col-8">
            ...
            <input id="registerButton" class="btn btn-primary mr-5" type="button" value="Xác nhận"/>
            <input class="btn btn-primary" type="reset" value="Hủy"/>
        </form>
    </div>
