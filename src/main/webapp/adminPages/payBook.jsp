...
<div class="container-xxl" style="background-color: #F5F5F5; height: 100%; padding: 0;">
    ...
    <div class="content">
        ...
        <div class="d-flex flex-row justify-content-around" style="padding: 15px;">
            ...
            <div class="addBook p-2"
                ...
                <form action="" style="margin-top: 35px;">
                    ...
                    <button class="btn btn-primary" style="display:block; margin: auto;">Thêm sách</button>
                </form>
            </div>
        </div>
        ...
        <div
            ...
            <p class="font-weight-bold">Thông tin trả (thời gian, mã số sách, tên sách, tác giả, nhà xuất bản, lần tái bản, phí phạt trễ hạn)</p>
            <p class="font-weight-bold">8:42:41 5/5/2021, 12316546, Java core, Bill Gate, Kim Đồng, 8, 0VND</p>
            <p class="font-weight-bold">8:42:41 5/5/2021, 12316546, Java core, Bill Gate, Kim Đồng, 8, 0VND</p>
            <p class="font-weight-bold">*Lưu ý: Nếu sách không thể trả thì thông báo</p>
        </div>

        <div class="d-flex flex-row justify-content-center mt-3">
            <button class="btn btn-primary pr-5 pl-5" style="margin-right: 80px;">Trả sách</button>
