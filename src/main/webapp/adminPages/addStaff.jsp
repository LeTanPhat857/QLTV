...
<body>
	<div class="container-xxl"
		...
		<div class="content d-flex justify-content-between"
			style="height: auto;">
			<div class="title  p-2 bd-highlight">Thêm nhân viên giả</div>

		</div>
		<div
			class="content text-center border border-dark rounded p-2 mr-5 mt-3	"
			style="width: 80%; height: auto">
			<form action="" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class="col-6">
						<img alt="" class="img-thumbnail rounded mx-auto d-block"
							style="max-width: 80%" src="images/trangTongQuan.jpg"> <input
							type="file" name="fileImg" multiple><br>
						<br>
					</div>
					<div class=" col-6 row">
						...
						<div class="form-group row col-12">
							<label for="inputEmail" class="col-4 col-form-label">Chức
								vụ </label> <select class="custom-select col-8" id="inputGroupSelect02">
						...
						<div class="form-group row col-12">
							<label for="inputEmail" class="col-4 col-form-label">Mật
								khẩu </label>
							<div class="col-8">
