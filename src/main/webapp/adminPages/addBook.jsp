...
<div class="container-xxl"
	...
	<div id="content">
		<div class="content d-flex justify-content-between"
			...
			<div class="title bd-highlight">Thêm sách</div>
		</div>
						...
						<div class="form-group row col-12" style="margin-bottom: 20px">
							...
							<div class="col-9">
								<input id="barCode" required type="text" class="form-control"
									placeholder="Nhập Barcode" name="name">
							</div>
						</div>
						...
						<div class="form-group row col-12" style="margin-bottom: 20px">
							...
							<div class="col-9">
								<input id="bookName" required type="text" class="form-control"
									placeholder="Tên sách" name="name">
							</div>
						</div>
						...
						<div class="form-group row col-12" style="margin-bottom: 20px">
							...
							<div class="col-9">
								<input type="number" required class="form-control"
									id="quantityBook" placeholder="Số trang sách">
							</div>
