...
<body>
	<div class="container-xxl"
		...
		<div class="content d-flex justify-content-between"
			style="height: auto;">
			<div class="title  p-2 bd-highlight">Chỉnh sửa nhân viên</div>
				<button type="button"
				class="btn btn-primary p-2 bd-highlight rounded-pill"
				data-toggle="button" aria-pressed="false">Thêm nhân viên</button>
			...
			<form action="" method="post" enctype = "multipart/form-data">
				<div class="row">
					...
					<div class=" col-6 row">
						...
						<div class="form-group row col-12">
							<label for="inputEmail" class="col-4 col-form-label">Chức vụ
							</label> 
						...
						<div class="form-group row col-12">
							...
							<div class="form-group row col-12">
							<label for="inputEmail" class="col-4 col-form-label">Mật khẩu
							</label>
							<div class="col-8">
